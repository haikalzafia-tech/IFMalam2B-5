<?php $__env->startSection('page_title', 'Buat Pengembalian Baru'); ?>

<?php $__env->startSection('content'); ?>
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="card-title">Form Transaksi Pengembalian</h4>
        <a href="<?php echo e(route('transaksi-retur.index')); ?>" class="btn btn-secondary btn-sm">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('transaksi-retur.store')); ?>" method="POST" id="form-retur">
            <?php echo csrf_field(); ?>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    ...
                    <select name="transaksi_id" id="transaksi_id" class="form-select select2" required>
                        ...
                        <option value="<?php echo e($t->id); ?>" <?php echo e(($transaksiTerpilih && $transaksiTerpilih->id == $t->id) ? 'selected' : ''); ?>>
                            <?php echo e($t->nomor_transaksi); ?> - <?php echo e($t->tanggal_transaksi->format('d/m/Y')); ?>

                            (<?php echo e($t->supplier->nama_supplier ?? 'Tanpa Supplier'); ?>)
                        </option>
                ...
                <div class="col-md-2">
                    ...
                    <input type="date" name="tanggal_retur" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" required>
                </div>
                <div class="col-md-12">
            ...
            <div class="mt-4 d-flex gap-2">
                ...
                <button type="button" class="btn btn-secondary" onclick="SigmaNotif.konfirmasiBatal('<?php echo e(route('transaksi-retur.index')); ?>')">Batal</button>
            </div>
        </form>
    </div>
</div>
...
<?php if($transaksiTerpilih): ?>
loadItemsByTransaksi(<?php echo e($transaksiTerpilih->id); ?>);
<?php endif; ?>
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.kai', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\IFMalam2B-5\resources\views/transaksi-retur/create.blade.php ENDPATH**/ ?>