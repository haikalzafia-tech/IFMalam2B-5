    ...
    <div class="modal fade" id="modalFormVarian" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <form method="POST" enctype="multipart/form-data" action="<?php echo e($action); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="produk_id" id="produk_id" value="<?php echo e($produk_id ?? ''); ?>">
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="nama_varian" id="nama_varian" class="form-control"
                                value="<?php echo e(old('nama_varian', $nama_varian ?? '')); ?>">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="rak_id" id="rak_id" class="form-control">
                                ...
                                <?php $__currentLoopData = $raks ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($rak->id); ?>" <?php echo e(old('rak_id', $rak_id ?? '') == $rak->id ? 'selected' : ''); ?>>
                                        <?php echo e($rak->zona->gudang->nama_gudang); ?> &raquo; <?php echo e($rak->zona->nama_zona); ?> &raquo; <?php echo e($rak->kode_rak); ?>
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="stok_varian" id="stok_varian" class="form-control"
                                        value="<?php echo e(old('stok_varian', $stok_varian ?? 0)); ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="berat" id="berat" class="form-control"
                                        placeholder="Contoh: 500gr" value="<?php echo e(old('berat', $berat ?? '')); ?>">
                                    <small class="text-danger"></small>
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="dimensi" id="dimensi" class="form-control"
                                placeholder="Contoh: 30x20x10cm" value="<?php echo e(old('dimensi', $dimensi ?? '')); ?>">
                            <small class="text-danger"></small>
                        </div>
                        <div class="form-group mb-3">
...
<?php /**PATH D:\laravel\IFMalam2B-5\resources\views/components/produk/form-varian.blade.php ENDPATH**/ ?>