...
<div>
    <button type="button" class="btn btn-round btn-icon border" id="btn-reset"
        onclick="window.location.href='<?php echo e(route($route)); ?>'">
        <i class="fas fa-redo" style="font-size: 15px"></i>
    </button>
</div><?php /**PATH D:\laravel\IFMalam2B-5\resources\views/components/button-reset-filter.blade.php ENDPATH**/ ?>