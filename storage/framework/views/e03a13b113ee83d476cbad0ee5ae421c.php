<?php $__env->startSection('page_title', 'Dashboard Analitik'); ?>

<?php $__env->startSection('content'); ?>

<div class="mb-4">
    <p class="text-muted mb-0">Selamat datang kembali, <strong class="text-navy"><?php echo e(Auth::user()->name); ?></strong>.</p>
</div>
        ...
        <div class="kartu-statistik h-100">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0" style="color: var(--sigma-navy-900)"><?php echo e($totalProduk); ?></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="kartu-statistik h-100" style="border-left: 3px solid var(--sigma-danger);">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0" style="color: var(--sigma-danger);"><?php echo e($stokMenipis ?? '0'); ?></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="kartu-statistik h-100">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0" style="color: var(--sigma-navy-900)"><?php echo e($totalMasuk ?? '0'); ?></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="kartu-statistik h-100">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <h3 class="fw-bold mb-0" style="color: var(--sigma-navy-900)"><?php echo e($totalKeluar ?? '0'); ?></h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                <div class="text-center mb-3">
                    <h2 class="fw-bold mb-0" style="color: var(--sigma-navy-500)"><?php echo e($persentaseKapasitas); ?>%</h2>
                ...
                <div class="progress mb-4" style="height: 10px;">
                    <div class="progress-bar bg-<?php echo e($persentaseKapasitas >= 90 ? 'danger' : ($persentaseKapasitas >= 70 ? 'warning' : 'success')); ?>"
                        style="width: <?php echo e($persentaseKapasitas); ?>%;"></div>
                </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <small class="fw-semibold" style="color: var(--sigma-navy-900)"><?php echo e($g->nama_gudang); ?></small>
                    ...
                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar bg-<?php echo e($g->persentase >= 90 ? 'danger' : ($g->persentase >= 70 ? 'warning' : 'success')); ?>"
                            style="width: <?php echo e($g->persentase); ?>%;"></div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><span class="fw-semibold" style="color: var(--sigma-navy-700)"><?php echo e($trx->nomor_transaksi); ?></span></td>
                                <td>
                                ...
                                <td class="fw-semibold"><?php echo e($trx->jumlah_barang); ?></td>
                                <td>
                                    <?php $statusColor = ['pending'=>'secondary','diproses'=>'warning','selesai'=>'success','dibatalkan'=>'danger']; ?>
                                    <span class="badge bg-<?php echo e($statusColor[$trx->status] ?? 'secondary'); ?>"><?php echo e(ucfirst($trx->status)); ?></span>
                                </td>
                            </tr>
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center py-2 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                    <div>
                        <small class="fw-semibold d-block" style="color: var(--sigma-navy-900)"><?php echo e($b->produk->nama_produk); ?> - <?php echo e($b->nama_varian); ?></small>
                        <small class="text-muted"><?php echo e($b->nomor_sku); ?> &middot; <?php echo e($b->rak->kode_rak ?? 'Belum ada lokasi'); ?></small>
                    </div>
                    <span class="badge bg-danger"><?php echo e($b->stok_varian); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.kai', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\IFMalam2B-5\resources\views/home.blade.php ENDPATH**/ ?>