            ...
            <div class="col-lg-7">
                <div class="card card-3d-premium">
                    <div class="card-header border-0 bg-transparent pt-4 px-4 d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge badge-primary px-3 py-2" style="border-radius: 10px;"><?php echo e($admins->count()); ?> User</span>
                    </div>
                    <div class="card-body px-4">
                        <div class="table-responsive">
                            <table class="table custom-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="fw-bold text-dark"><?php echo e($admin->name); ?></div>
                                            <small class="text-muted">Dibuat: <?php echo e($admin->created_at->format('d/m/Y')); ?></small>
                                        </td>
                                        <td><span class="text-muted"><?php echo e($admin->email); ?></span></td>
                                        <td>
                                            <form action="<?php echo e(route('users.destroy', $admin->id)); ?>" method="POST" onsubmit="return confirm('Hapus admin ini?');">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.kai', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\IFMalam2B-5\resources\views/components/manager/kelola-admin.blade.php ENDPATH**/ ?>