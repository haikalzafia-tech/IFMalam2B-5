        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card card-profile card-3d">
                    <div class="card-header" style="background-image: url('<?php echo e(asset('template/assets/img/blogpost.jpg')); ?>'); border-radius: 15px 15px 0 0; height: 120px;">
                    ...
                    <div class="card-body">
                        <div class="user-profile text-center mt-5">
                            <div class="name fw-bold" style="font-size: 1.2rem;"><?php echo e(Auth::user()->name); ?></div>
                            <div class="job text-primary"><?php echo e(ucfirst(Auth::user()->role)); ?></div>
                            <div class="desc text-muted mt-2"><i class="fa fa-envelope"></i> <?php echo e(Auth::user()->email); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    <div class="form-group p-0">
                                        ...
                                        <input type="text" name="name" class="form-control shadow-sm border-0" value="<?php echo e(Auth::user()->name); ?>" style="background: #f8f9fa;">
                                    </div>
                                </div>
                                <div class="col-sm-6 mb-3">
                                    <div class="form-group p-0">
                                        <label class="fw-bold">Alamat Email</label>
                                        <input type="email" name="email" class="form-control shadow-sm border-0" value="<?php echo e(Auth::user()->email); ?>" style="background: #f8f9fa;">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.kai', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\IFMalam2B-5\resources\views/auth/passwords/profile.blade.php ENDPATH**/ ?>