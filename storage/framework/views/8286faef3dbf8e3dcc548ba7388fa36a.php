...
<body>
    ...
    <div class="auth-card">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="mb-3">
                ...
                <div class="input-group-custom">
                    ...
                    <input type="email" name="email" class="form-control form-control-sigma" placeholder="user@polibatam.ac.id" value="<?php echo e(old('email')); ?>" required autofocus>
                </div>
            </div>
        ...
        <div class="footer-links">
            <p class="text-white-50">Belum punya akun? <a href="<?php echo e(route('register')); ?>">Daftar Sekarang</a></p>
...
<?php /**PATH D:\laravel\IFMalam2B-5\resources\views/auth/login.blade.php ENDPATH**/ ?>