...
<head>
    ...
    <title><?php echo e($pageTitle ?? 'SIGMA - Sistem Manajemen Gudang'); ?></title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-sigma fixed-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="<?php echo e(asset('template/assets/img/SIGMA.png')); ?>" alt="SIGMA" height="45" class="me-3">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="ms-auto d-flex align-items-center">
                    <?php if(auth()->guard()->check()): ?>
                        <span class="me-3 opacity-75">Halo, <strong><?php echo e(Auth::user()->name); ?></strong></span>
                        <a href="<?php echo e(route('logout')); ?>" class="btn btn-outline-light btn-sm rounded-pill px-4">Keluar</a>
                    <?php endif; ?>

                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light rounded-pill px-4 fw-bold">Masuk</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    ...
                    <div class="d-flex gap-3">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-sigma-main btn-lg">Mulai Sekarang <i class="fa-solid fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- --- Section: Tim Pengembang (Creator) --- -->
                    ...
                    <div class="feature-card text-start d-flex align-items-center p-4" style="border-radius: 30px; border: 1px solid rgba(61, 181, 241, 0.3);">
                        <div class="creator-avatar-wrapper me-4">
                            ...
                            <div class="icon-3d-box mb-0" style="width: 90px; height: 90px; border-radius: 50%; overflow: hidden; padding: 0; background: linear-gradient(135deg, #FF4B2B, #FF416C);">
                                <img src="<?php echo e(asset('template/assets/img/foro-bunga.jpeg')); ?>" alt="Haikal Mubaroq Zafia" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                    ...
                    <div class="feature-card text-start d-flex align-items-center p-4" style="border-radius: 30px;">
                        <div class="creator-avatar-wrapper me-4">
                            ...
                            <div class="icon-3d-box mb-0" style="width: 90px; height: 90px; border-radius: 50%; overflow: hidden; padding: 0;">
                               <img src="<?php echo e(asset('template/assets/img/foto-haikal-fadhil.jpeg')); ?>" alt="Haikal Mubaroq Zafia" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                        <div class="creator-info">
                    ...
                    <div class="feature-card text-start d-flex align-items-center p-4" style="border-radius: 30px;">
                        <div class="creator-avatar-wrapper me-4">
                            ...
                            <div class="icon-3d-box mb-0" style="width: 90px; height: 90px; border-radius: 50%; overflow: hidden; padding: 0; background: linear-gradient(135deg, #2b59c3, #00d2ff);">
                                <img src="<?php echo e(asset('template/assets/img/foto-haikal-mubaroq.jpeg')); ?>" alt="Haikal Mubaroq Zafia" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                        <div class="creator-info">
    ...
    <script>
        ...
        const logoTexture = textureLoader.load("<?php echo e(asset('template/assets/img/SIGMA.png')); ?>");
...
<?php /**PATH D:\laravel\IFMalam2B-5\resources\views/landing/index.blade.php ENDPATH**/ ?>