<?php $__env->startSection('page_title', 'Transaksi Masuk'); ?>

<?php $__env->startSection('content'); ?>
<div class="card">
    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
        <h4 class="card-title">Daftar Transaksi Masuk</h4>
        <div class="d-flex gap-2">
            ...
            <?php if(Auth::check() && Auth::user()->role == 'admin'): ?>
                <a href="<?php echo e(route('transaksi-masuk.create')); ?>" class="btn btn-primary btn-sm">
...
<?php endif; ?>
            ...
            <div class="col-6 col-md-3">
                <select name="supplier_id" class="form-select form-select-sm">
                    ...
                    <option value="<?php echo e($s->id); ?>" <?php echo e(request('supplier_id') == $s->id ? 'selected' : ''); ?>><?php echo e($s->nama_supplier); ?></option>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($t->supplier->nama_supplier ?? '-'); ?></td>
                        <td><?php echo e($t->gudang->nama_gudang); ?></td>
                        <td><?php echo e($t->nomor_po ?? '-'); ?></td>
                        ...
                        <td class="text-center">
                            <a href="<?php echo e(route('transaksi-masuk.show', $t)); ?>" class="btn btn-xs btn-info">
                                <i class="fas fa-eye"></i>
                            </a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr><td colspan="9" class="text-center text-muted py-5">Belum ada transaksi masuk.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.export-modal','data' => ['route' => 'export.transaksi-masuk','judul' => 'Export Transaksi Masuk']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['route' => 'export.transaksi-masuk','judul' => 'Export Transaksi Masuk']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.kai', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\IFMalam2B-5\resources\views/transaksi-masuk/index.blade.php ENDPATH**/ ?>