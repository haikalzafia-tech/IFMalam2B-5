    ...
    <div class="col-md-11">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('transaksi-retur.index') }}" class="btn btn-sm btn-secondary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('transaksi-retur.store') }}" method="POST" id="form-retur">
                    ...
                    <h6 class="text-muted mb-3"><i class="fas fa-info-circle me-1"></i> Informasi Retur</h6>
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Transaksi Asal <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="jenis_retur" class="form-select" required>
                                ...
                                <option value="retur_masuk">Retur Masuk (barang kembali ke gudang)</option>
                                <option value="retur_keluar">Retur Keluar (barang kembali ke supplier)</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                    ...
                    <h6 class="text-muted mb-3"><i class="fas fa-boxes me-1"></i> Daftar Barang Retur</h6>
                    ...
                    <div class="table-responsive d-none" id="wrapper-items">
    ...
    try {
        ...
        items.forEach((item, idx) => {
            ...
            <tr>
                ...
                <td>${item.qty}</td>
                <td>
                    <input type="number" class="form-control form-control-sm input-qty-retur" min="1" max="${item.qty}" disabled>
                </td>
                <td>
                ...
                <td class="text-center">
                    <input type="checkbox" class="form-check-input chk-pilih" style="width:20px;height:20px;">
                </td>
            </tr>`);
        });
...
// Enable/disable input sesuai checkbox dipilih
...
// Saat submit, build hidden inputs items[] dari row yang dicek
document.getElementById('form-retur').addEventListener('submit', function(e) {
    ...
    if (!adaTerpilih) {
        e.preventDefault();
        alert('Pilih minimal 1 barang yang akan diretur (centang checkbox).');
    }
});

// Jika ada transaksi terpilih dari awal (misal dari halaman detail transaksi)
