...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('template') }}/assets/css/sigma-design-system.css" />
...
<body>
    ...
    <!-- jQuery Scrollbar -->
    <script src="{{ asset('template') }}/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js">
    </script>
    ...
    <!-- jQuery Sparkline -->
    <script src="{{ asset('template') }}/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js">
    </script>
    ...
    <!-- Bootstrap Notify -->
    <script src="{{ asset('template') }}/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js">
    </script>
