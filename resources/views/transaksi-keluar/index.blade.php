        ...
        <div class="row align-items-end">
            <div class="col-11">
                ...
                <div class="col-2" d-flex gap-1>
                    ...
                    <div>
                        <label for="filter" class="form-label">&nbsp;</label>
                        <button type="reset" onclick="window.location.href='{{ route('transaksi-keluar.index') }}'"
                ...
                <form class="row align-items-end" action="{{ route('transaksi-keluar.index') }}" method="GET">
                    <div class="col-md-3">
                        <label for="penerima" class="form-label">penerima</label>
                    ...
                    <div class="col-md-3">
                        <div class="d-flex gap-1">
                                <label for="filter" class="form-label">&nbsp;</label>
                            <button type="submit" class="btn btn-primary btn-round border flex-fill">
                                <i class="fas fa-search">Cari</i>
                            </button>
                                <label for="filter" class="form-label">&nbsp;</label>
                            <a href="{{ route('transaksi-masuk.index') }}"
                                class="btn btn-outline-danger btn-round flex-fill text-center">
                                Reset
                            </a>
                        </div>
                    </div>
